...
nix-build https://github.com/eikek/chee/archive/release/0.2.1.tar.gz
#+end_src

or install it with

#+begin_src shell :exports code
nix-env -if https://github.com/eikek/chee/archive/release/0.2.1.tar.gz
#+end_src
...
- [[https://eknet.org/main/projects/chee/chee-0.2.1.zip][chee 0.2.1]]
...
Click [[https://eknet.org/main/projects/chee/manual-0.2.1.html][here]] to read the manual now.
